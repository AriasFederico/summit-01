...
import home from '../../../../../public/banners/home.svg';

export const Hero = () => {
	return (
		<main className='Hero'>
			<img className='Hero-bn' src={home} alt='banner-home' />
			<div className='Hero-item'>
				...
				<p className='Hero-p'>
					...
					eficiente. Con nuestras potentes herramientas y características
					intuitivas, los pequeños negocios y emprendedores pueden optimizar sus
					procesos, llevar un control detallado de sus precios y mejorar su
					rentabilidad sin complicaciones
				</p>
				<Link className='Hero-link' to={'register'}>
					Registra ahora tu negocio
				</Link>
			</div>
		</main>
	);
	...
	return (
		<div className='Hero-tools'>
			...
			<svg
				...
				height='16'
				fill='currentColor'
				className='Hero-tool Hero-calculator'
				viewBox='0 0 16 16'
			>
